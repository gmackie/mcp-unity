...
import { registerSceneManagementTools } from "./tools/sceneManagementTools.js";
import { registerSceneManagementResources } from "./resources/sceneManagementResources.js";
/* These modules will be created later
import { registerPrefabManagementTools } from './tools/prefab-management.js';
import { registerSceneManagementTools } from './tools/scene-management.js';
import { GetGameObjectsResource } from './resources/get-game-objects.js';
import { GetPrefabsResource } from './resources/get-prefabs.js';
import { GetScenesResource } from './resources/get-scenes.js';
import { GetSceneInfoResource } from './resources/get-scene-info.js';
*/
...
registerSceneManagementTools(toolRegistry, mcpUnity, toolLogger);
...
// Register scene management resources
registerSceneManagementResources(resourceRegistry, mcpUnity, resourceLogger);

// Use the tool registry to register tools
toolRegistry.registerWithServer(server);
resourceRegistry.registerWithServer(server);

/* These registrations will be implemented later
// Register tools
registerGameObjectTools(server);
registerComponentTools(server);
registerPrefabManagementTools(server);
registerSceneManagementTools(server);

// Register resources
server.registerResource(new GetGameObjectsResource());
server.registerResource(new GetPrefabsResource());
server.registerResource(new GetScenesResource());
server.registerResource(new GetSceneInfoResource());
*/
